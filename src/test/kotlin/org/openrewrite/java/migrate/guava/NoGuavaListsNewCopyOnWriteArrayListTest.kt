...
class NoGuavaListsNewCopyOnWriteArrayListTest: JavaRecipeTest {
    ...
    override val recipe: Recipe
        get() = NoGuavaListsNewCopyOnWriteArrayList()

    @Test
    fun replaceWithNewCopyOnWriteArrayList() = assertChanged(
        before = """
    ...
    @Test
    fun replaceWithNewCopyOnWriteArrayListIterable() = assertChanged(
        before = """
            import com.google.common.collect.*;
