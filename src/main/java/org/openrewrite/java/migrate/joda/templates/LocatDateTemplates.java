...
public class LocatDateTemplates implements Templates {
    ...
    final MethodMatcher toDate = new MethodMatcher(JODA_LOCAL_DATE + " toDate()");

    final MethodMatcher compareTo = new MethodMatcher(JODA_LOCAL_DATE + " compareTo(org.joda.time.ReadablePartial)");
    ...
    final MethodMatcher hashCode = new MethodMatcher(JODA_LOCAL_DATE + " hashCode()");
    ...
    final JavaTemplate.Builder toDateTemplate = JavaTemplate.builder("Date.from(#{any(java.time.LocalDate)}.atStartOfDay(ZoneId.systemDefault()).toInstant())")
            .imports(JAVA_ZONE_ID);

    final JavaTemplate.Builder compareToTemplate = JavaTemplate.builder("#{any(java.time.LocalDate)}.compareTo(#{any(java.time.chrono.ChronoLocalDate)})");
    ...
    final JavaTemplate.Builder hashCodeTemplate = JavaTemplate.builder("#{any(java.time.LocalDate)}.hashCode()");
    ...
    private final List<MethodTemplate> templates = new ArrayList<MethodTemplate>() {
        {
            ...
            add(new MethodTemplate(compareTo, build(compareToTemplate)));
