...
public class PeriodTemplates implements Templates{
    final MethodMatcher newPeriod = new MethodMatcher(JODA_PERIOD + "<constructor>()");
    final MethodMatcher newPeriodFromObject = new MethodMatcher(JODA_PERIOD + "<constructor>(Object)");
    ...
    final JavaTemplate.Builder zeroPeriodTemplate = JavaTemplate.builder("Period.ZERO");
    ...
    private final List<MethodTemplate> templates = new ArrayList<MethodTemplate>() {
        {
            add(new MethodTemplate(newPeriod, build(zeroPeriodTemplate)));
            ...
            add(new MethodTemplate(newPeriodFromObject, JODA_MULTIPLE_MAPPING_POSSIBLE_TEMPLATE));
        }
    };
