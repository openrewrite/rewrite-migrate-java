...
public class DateTimeTemplates implements Templates {
    ...
    private final List<MethodTemplate> templates;
    {
        ...
        templates.add(new MethodTemplate(newDateTime, dateTimeTemplate));
        templates.add(new MethodTemplate(newDateTimeWithZone, dateTimeWithZoneTemplate));
        templates.add(new MethodTemplate(newDateTimeWithEpoch, dateTimeWithEpochTemplate));
        templates.add(new MethodTemplate(newDateTimeWithEpochAndZone, dateTimeWithEpochAndZoneTemplate));
        templates.add(new MethodTemplate(newDateTimeWithMin, dateTimeWithMinTemplate));
        templates.add(new MethodTemplate(newDateTimeWithMinAndZone, dateTimeWithMinAndZoneTemplate));
        templates.add(new MethodTemplate(newDateTimeWithSec, dateTimeWithSecTemplate));
        templates.add(new MethodTemplate(newDateTimeWithSecAndZone, dateTimeWithSecAndZoneTemplate));
        templates.add(new MethodTemplate(newDateTimeWithMillis, dateTimeWithMillisTemplate));
        templates.add(new MethodTemplate(newDateTimeWithMillisAndZone, dateTimeWithMillisAndZoneTemplate));
        templates.add(new MethodTemplate(dateTimeNow, dateTimeTemplate));
        templates.add(new MethodTemplate(dateTimeNowWithZone, dateTimeWithZoneTemplate));
        templates.add(new MethodTemplate(dateTimeParse, dateTimeParseTemplate));
        templates.add(new MethodTemplate(dateTimeParseWithFormatter, dateTimeParseWithFormatterTemplate));
        templates.add(new MethodTemplate(toDateTime, toDateTimeTemplate));
        templates.add(new MethodTemplate(toDateTimeWithZone, withZoneTemplate));
        templates.add(new MethodTemplate(withMillis, withMillisTemplate, m -> {
        ...
        templates.add(new MethodTemplate(withZoneRetainFields, withZoneRetainFieldsTemplate));
        templates.add(new MethodTemplate(withEarlierOffsetAtOverlap, withEarlierOffsetAtOverlapTemplate));
        templates.add(new MethodTemplate(withLaterOffsetAtOverlap, withLaterOffsetAtOverlapTemplate));
        templates.add(new MethodTemplate(withDate, withDateTemplate));
        templates.add(new MethodTemplate(withDateLocalDate, withTemporalAdjusterTemplate));
        templates.add(new MethodTemplate(withTime, withTimeTemplate));
        templates.add(new MethodTemplate(withTimeLocalTime, withTemporalAdjusterTemplate));
        templates.add(new MethodTemplate(withTimeAtStartOfDay, withTimeAtStartOfDayTemplate, m -> {
            J.MethodInvocation mi = (J.MethodInvocation) m;
        ...
        templates.add(new MethodTemplate(plusLong, plusMillisTemplate));
        templates.add(new MethodTemplate(plusReadableDuration, plusReadableDurationTemplate));
        templates.add(new MethodTemplate(plusYears, plusYearsTemplate));
        templates.add(new MethodTemplate(plusMonths, plusMonthsTemplate));
        templates.add(new MethodTemplate(plusWeeks, plusWeeksTemplate));
        templates.add(new MethodTemplate(plusDays, plusDaysTemplate));
        templates.add(new MethodTemplate(plusHours, plusHoursTemplate));
        templates.add(new MethodTemplate(plusMinutes, plusMinutesTemplate));
        templates.add(new MethodTemplate(plusSeconds, plusSecondsTemplate));
        templates.add(new MethodTemplate(plusMillis, plusMillisTemplate));
        templates.add(new MethodTemplate(minusLong, minusMillisTemplate));
        templates.add(new MethodTemplate(minusReadableDuration, minusReadableDurationTemplate));
        templates.add(new MethodTemplate(minusYears, minusYearsTemplate));
        templates.add(new MethodTemplate(minusMonths, minusMonthsTemplate));
        templates.add(new MethodTemplate(minusWeeks, minusWeeksTemplate));
        templates.add(new MethodTemplate(minusDays, minusDaysTemplate));
        templates.add(new MethodTemplate(minusHours, minusHoursTemplate));
        templates.add(new MethodTemplate(minusMinutes, minusMinutesTemplate));
        templates.add(new MethodTemplate(minusSeconds, minusSecondsTemplate));
        templates.add(new MethodTemplate(minusMillis, minusMillisTemplate));
        templates.add(new MethodTemplate(toLocalDateTime, toLocalDateTimeTemplate));
        templates.add(new MethodTemplate(toLocalDate, toLocalDateTemplate));
        templates.add(new MethodTemplate(toLocalTime, toLocalTimeTemplate));
        templates.add(new MethodTemplate(withYear, withYearTemplate));
        templates.add(new MethodTemplate(withWeekyear, withWeekyearTemplate));
        templates.add(new MethodTemplate(withMonthOfYear, withMonthOfYearTemplate));
        templates.add(new MethodTemplate(withWeekOfWeekyear, withWeekOfWeekyearTemplate));
        templates.add(new MethodTemplate(withDayOfYear, withDayOfYearTemplate));
        templates.add(new MethodTemplate(withDayOfMonth, withDayOfMonthTemplate));
        templates.add(new MethodTemplate(withDayOfWeek, withDayOfWeekTemplate));
        templates.add(new MethodTemplate(withHourOfDay, withHourOfDayTemplate));
        templates.add(new MethodTemplate(withMinuteOfHour, withMinuteOfHourTemplate));
        templates.add(new MethodTemplate(withSecondOfMinute, withSecondOfMinuteTemplate));
        templates.add(new MethodTemplate(withMillisOfSecond, withMillisOfSecondTemplate));
        templates.add(new MethodTemplate(withMillisOfDay, withMillisOfDayTemplate));
    }
}
