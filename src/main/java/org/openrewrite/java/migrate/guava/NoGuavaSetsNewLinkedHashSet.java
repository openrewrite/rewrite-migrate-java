...
public class NoGuavaSetsNewLinkedHashSet extends Recipe {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return Preconditions.check(Preconditions.or(
            ...
            final JavaTemplate newLinkedHashSet = JavaTemplate.builder(this::getCursor, "new LinkedHashSet<>()")
                    .imports("java.util.LinkedHashSet")
                    .build();

            final JavaTemplate newLinkedHashSetCollection = JavaTemplate.builder(this::getCursor, "new LinkedHashSet<>(#{any(java.util.Collection)})")
                    .imports("java.util.LinkedHashSet")
                    .build();

            final JavaTemplate newLinkedHashSetCapacity = JavaTemplate.builder(this::getCursor, "new LinkedHashSet<>(#{any(int)})")
                    .imports("java.util.LinkedHashSet")
                    .build();
